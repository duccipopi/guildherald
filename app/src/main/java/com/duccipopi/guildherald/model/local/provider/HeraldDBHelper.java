...
public class HeraldDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_CHARACTER_TABLE = "CREATE TABLE " +
            ...
            HeraldProviderContract.CharacterEntry.COLUMN_ACHIEVEMENTS + " INTEGER NOT NULL, " +
            ...
            "PRIMARY KEY (" +
            HeraldProviderContract.CharacterEntry.COLUMN_NAME +
            "," +
            HeraldProviderContract.CharacterEntry.COLUMN_REALM +
            "));";
    ...
    private static final String SQL_CREATE_GUILD_TABLE = "CREATE TABLE " +
            ...
            HeraldProviderContract.GuildEntry.COLUMN_NAME + " TEXT NOT NULL, " +
            HeraldProviderContract.GuildEntry.COLUMN_REALM + " TEXT NOT NULL, " +
            HeraldProviderContract.GuildEntry.COLUMN_FACTION + " INTEGER NOT NULL, " +
            HeraldProviderContract.GuildEntry.COLUMN_ACHIEVEMENTS + " INTEGER NOT NULL, " +
            HeraldProviderContract.GuildEntry.COLUMN_EMBLEM + " TEXT, " +
            "PRIMARY KEY(" +
            HeraldProviderContract.GuildEntry.COLUMN_NAME +
            "," +
            HeraldProviderContract.GuildEntry.COLUMN_REALM +
            "));";
